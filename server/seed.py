...
if __name__ == "__main__":
  with app.app_context():
    ...
    review_1 = Review(user_id=1, instrument_id=1, rental_id=1, created_at=datetime(2024,8,10,10,10,0))
    review_2 = Review(user_id=2, instrument_id=2, rental_id=2, created_at=datetime(2024,8,10,10,10,0))
